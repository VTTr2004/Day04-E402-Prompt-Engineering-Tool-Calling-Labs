...
class OrderDataStore:
    """
    Local catalog and order persistence helper for the electronics order agent.
    """
            ...
            results.append(
                (
                    ...
                    product.product_id,
                    {
                        ...
                        "next_step": (
                            "Call get_product_details with the chosen product_id list to verify price, "
    ...
    def get_discount(self, *, seed_hint: str, customer_tier: str = "standard") -> dict:
        """
        Simulate a deterministic campaign discount for grading.
        """
    ...
    def calculate_order_totals(self, *, items: list[OrderLineInput], detail_token: str, discount_rate: float) -> dict:
        """
        Validate the order lines and compute subtotal, discount, and final total.
        """
    ...
    @staticmethod
    def _normalize_order_lines(items: list[OrderLineInput]) -> list[OrderLineInput]:
